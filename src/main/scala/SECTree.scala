/**
 * HasLang implementation SEC code representation.
 *
...
object SECTree {
    ...
    /**
     * Nil instruction. Push the empty list onto the operand stack.
     */
    case class INil () extends Instr

    /**
     * Cons instruction. cons (2nd from stack top , stack top)
     * Pop the operands and push the result onto the operand stack.
     */
    case class ICons () extends Instr

    /**
     * Head instruction. head (stack top)
     * Pop the operand and push the result onto the operand stack.
     */
    case class IHead () extends Instr

    /**
     * Tail instruction. tail (stack top)
     * Pop the operand and push the result onto the operand stack.
     */
    case class ITail () extends Instr

    /**
     * Length instruction. length (stack top)
     * Pop the operand and push the result onto the operand stack.
     */
    ...
    /**
     * A list machine value.
     */
    case class MList (value : List[Int]) extends MValue
